...
function reportModuleLoadFailure(program, error) {
    return __awaiter(this, void 0, void 0, function* () {
        yield throwOrPrintModuleLoadError(program, error);
...
function npmPackageRootFromProgramPath(programPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { packageDirectory } = yield dynamicImport("pkg-dir");
        // Check if programPath is a directory. If not, then we
        // look at it's parent dir for the package root.
        let isDirectory = false;
        try {
            const fileStat = yield fspromises.lstat(programPath);
        ...
        const pkgDir = yield packageDirectory({
...
function throwOrPrintModuleLoadError(program, error) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // one exists.
        const packageRoot = yield npmPackageRootFromProgramPath(program);
...
${error_1.defaultErrorMessage(err)}`);
        ...
        const runProgram = () => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (errorCode === "MODULE_NOT_FOUND") {
                    ...
                    yield reportModuleLoadFailure(program, e);
                }
                throw e;
            }
            finally {
        ...
        const stackOutputs = yield stack.runInPulumiStack(runProgram);
