...
const __1 = require("../..");
const closure = __importStar(require("./createClosure"));
...
function serializeJavaScriptText(outerClosure, exportName, isFactoryFunction) {
    ...
    function emitFunctionWorker(functionInfo, varName) {
        ...
        capturedValues.this = undefined;
        capturedValues.arguments = undefined;
    ...
    function isSimplePropertyInfo(info) {
        ...
        return (info.enumerable === true && info.writable === true && info.configurable === true && !info.get && !info.set);
    }
 ...
 */
function importIdentifier(identifier) {
