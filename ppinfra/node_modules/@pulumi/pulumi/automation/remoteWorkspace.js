...
function createLocalWorkspace(args, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!args.url && !(opts === null || opts === void 0 ? void 0 : opts.inheritSettings)) {
        ...
        if (!args.branch && !args.commitHash && !(opts === null || opts === void 0 ? void 0 : opts.inheritSettings)) {
        ...
        const localOpts = {
            ...
            remoteInheritSettings: opts === null || opts === void 0 ? void 0 : opts.inheritSettings,
        };
