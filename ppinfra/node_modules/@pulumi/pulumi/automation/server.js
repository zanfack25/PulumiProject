...
const runtimeConfig = __importStar(require("../runtime/config"));
const debuggable = __importStar(require("../runtime/debuggable"));
...
const langproto = __importStar(require("../proto/language_pb"));
