 ...
 * ```
 */
export declare function getDefaultKmsKey(opts?: pulumi.InvokeOptions): Promise<GetDefaultKmsKeyResult>;
/**
 ...
 * ```
 */
export declare function getDefaultKmsKeyOutput(opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDefaultKmsKeyResult>;
