 ...
 * ```
 */
function getDefaultKmsKey(opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("aws:ebs/getDefaultKmsKey:getDefaultKmsKey", {}, opts);
}
 ...
 * ```
 */
function getDefaultKmsKeyOutput(opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("aws:ebs/getDefaultKmsKey:getDefaultKmsKey", {}, opts);
}
