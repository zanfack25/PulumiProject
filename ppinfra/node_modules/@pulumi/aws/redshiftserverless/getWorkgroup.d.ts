 ...
 * ```
 */
export declare function getWorkgroup(args: GetWorkgroupArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkgroupResult>;
/**
 ...
 * ```
 */
export declare function getWorkgroupOutput(args: GetWorkgroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkgroupResult>;
/**
 * A collection of arguments for invoking getWorkgroup.
 */
