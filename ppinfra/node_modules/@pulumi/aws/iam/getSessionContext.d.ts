 ...
 * ```
 */
export declare function getSessionContextOutput(args: GetSessionContextOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSessionContextResult>;
/**
 * A collection of arguments for invoking getSessionContext.
 */
