 ...
 * ```
 */
export declare function getInstanceProfile(args: GetInstanceProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceProfileResult>;
/**
 ...
 * ```
 */
export declare function getInstanceProfileOutput(args: GetInstanceProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceProfileResult>;
/**
 * A collection of arguments for invoking getInstanceProfile.
 */
