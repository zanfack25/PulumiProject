 ...
 * ```
 */
export declare function getUserSshKey(args: GetUserSshKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetUserSshKeyResult>;
/**
 ...
 * ```
 */
export declare function getUserSshKeyOutput(args: GetUserSshKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUserSshKeyResult>;
/**
 * A collection of arguments for invoking getUserSshKey.
 */
