 ...
 * ```
 */
export declare function getReservedCacheNodeOffering(args: GetReservedCacheNodeOfferingArgs, opts?: pulumi.InvokeOptions): Promise<GetReservedCacheNodeOfferingResult>;
/**
 ...
 * ```
 */
export declare function getReservedCacheNodeOfferingOutput(args: GetReservedCacheNodeOfferingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReservedCacheNodeOfferingResult>;
/**
 * A collection of arguments for invoking getReservedCacheNodeOffering.
 */
