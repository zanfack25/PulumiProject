 ...
 * ```
 */
export declare function getQuicksightUser(args: GetQuicksightUserArgs, opts?: pulumi.InvokeOptions): Promise<GetQuicksightUserResult>;
/**
 ...
 * ```
 */
export declare function getQuicksightUserOutput(args: GetQuicksightUserOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetQuicksightUserResult>;
/**
 * A collection of arguments for invoking getQuicksightUser.
 */
