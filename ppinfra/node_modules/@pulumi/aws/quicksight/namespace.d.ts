...
export declare class Namespace extends pulumi.CustomResource {
     ...
     */
    readonly capacityRegion: pulumi.Output<string>;
    /**
     * Creation status of the namespace.
     */
    readonly creationStatus: pulumi.Output<string>;
    /**
     * User identity directory type. Defaults to `QUICKSIGHT`, the only current valid value.
     */
    readonly identityStore: pulumi.Output<string>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.quicksight.NamespaceTimeouts | undefined>;
    /**
