 ...
 * ```
 */
export declare function getQuicksightGroup(args: GetQuicksightGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetQuicksightGroupResult>;
/**
 ...
 * ```
 */
export declare function getQuicksightGroupOutput(args: GetQuicksightGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetQuicksightGroupResult>;
/**
 * A collection of arguments for invoking getQuicksightGroup.
 */
