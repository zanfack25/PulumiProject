...
export declare class VpcConnector extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcConnectorState, opts?: pulumi.CustomResourceOptions): VpcConnector;
    /**
     ...
     */
    readonly vpcConnectorName: pulumi.Output<string>;
    /**
