 ...
 * ```
 */
export declare function getSigningJob(args: GetSigningJobArgs, opts?: pulumi.InvokeOptions): Promise<GetSigningJobResult>;
/**
 ...
 * ```
 */
export declare function getSigningJobOutput(args: GetSigningJobOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSigningJobResult>;
/**
 * A collection of arguments for invoking getSigningJob.
 */
