 ...
 * ```
 */
export declare function getMulticastDomainOutput(args?: GetMulticastDomainOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMulticastDomainResult>;
/**
 * A collection of arguments for invoking getMulticastDomain.
 */
