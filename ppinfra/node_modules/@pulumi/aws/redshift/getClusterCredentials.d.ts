 ...
 * ```
 */
export declare function getClusterCredentials(args: GetClusterCredentialsArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterCredentialsResult>;
/**
 ...
 * ```
 */
export declare function getClusterCredentialsOutput(args: GetClusterCredentialsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetClusterCredentialsResult>;
/**
 * A collection of arguments for invoking getClusterCredentials.
 */
