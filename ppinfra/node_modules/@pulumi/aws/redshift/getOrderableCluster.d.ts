 ...
 * ```
 */
export declare function getOrderableClusterOutput(args?: GetOrderableClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrderableClusterResult>;
/**
 * A collection of arguments for invoking getOrderableCluster.
 */
