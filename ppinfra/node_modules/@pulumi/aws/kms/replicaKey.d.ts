...
export declare class ReplicaKey extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReplicaKeyState, opts?: pulumi.CustomResourceOptions): ReplicaKey;
    /**
     ...
     */
    readonly keyRotationEnabled: pulumi.Output<boolean>;
    /**
