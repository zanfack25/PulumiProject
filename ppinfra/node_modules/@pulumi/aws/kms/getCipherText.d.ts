 ...
 * ```
 */
export declare function getCipherText(args: GetCipherTextArgs, opts?: pulumi.InvokeOptions): Promise<GetCipherTextResult>;
/**
 ...
 * ```
 */
export declare function getCipherTextOutput(args: GetCipherTextOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCipherTextResult>;
/**
 * A collection of arguments for invoking getCipherText.
 */
