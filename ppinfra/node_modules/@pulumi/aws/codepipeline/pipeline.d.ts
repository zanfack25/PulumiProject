...
export declare class Pipeline extends pulumi.CustomResource {
     ...
     */
    readonly artifactStores: pulumi.Output<outputs.codepipeline.PipelineArtifactStore[]>;
    /**
     ...
     */
    readonly executionMode: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly pipelineType: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly stages: pulumi.Output<outputs.codepipeline.PipelineStage[]>;
    /**
     ...
     */
    readonly triggers: pulumi.Output<outputs.codepipeline.PipelineTrigger[]>;
    /**
     * A pipeline-level variable block. Valid only when `pipelineType` is `V2`. Variable are documented below.
     */
    readonly variables: pulumi.Output<outputs.codepipeline.PipelineVariable[] | undefined>;
    /**
