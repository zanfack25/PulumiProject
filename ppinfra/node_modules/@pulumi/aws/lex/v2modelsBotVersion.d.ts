 ...
 * ```
 */
export declare class V2modelsBotVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: V2modelsBotVersionState, opts?: pulumi.CustomResourceOptions): V2modelsBotVersion;
    /**
     * Returns true if the given object is an instance of V2modelsBotVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is V2modelsBotVersion;
    /**
     ...
     */
    readonly localeSpecification: pulumi.Output<{
        [key: string]: outputs.lex.V2modelsBotVersionLocaleSpecification;
    }>;
    readonly timeouts: pulumi.Output<outputs.lex.V2modelsBotVersionTimeouts | undefined>;
    /**
...
export interface V2modelsBotVersionState {
     ...
     * * `sourceBotVersion` - (Required) The version of a bot used for a bot locale. Valid values: `DRAFT`, a numeric version.
     */
    localeSpecification?: pulumi.Input<{
        [key: string]: pulumi.Input<inputs.lex.V2modelsBotVersionLocaleSpecification>;
    }>;
