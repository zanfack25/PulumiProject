 ...
 * ```
 */
export declare function getIntent(args: GetIntentArgs, opts?: pulumi.InvokeOptions): Promise<GetIntentResult>;
/**
 ...
 * ```
 */
export declare function getIntentOutput(args: GetIntentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIntentResult>;
/**
 * A collection of arguments for invoking getIntent.
 */
