...
export declare class PublishingDestination extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PublishingDestinationState, opts?: pulumi.CustomResourceOptions): PublishingDestination;
    /**
     ...
     */
    readonly destinationType: pulumi.Output<string | undefined>;
    /**
