 ...
 * ```
 */
export declare function getEventConnectionOutput(args: GetEventConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEventConnectionResult>;
/**
 * A collection of arguments for invoking getEventConnection.
 */
