 ...
 * ```
 */
export declare class EventApiDestination extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EventApiDestinationState, opts?: pulumi.CustomResourceOptions): EventApiDestination;
    /**
     * Returns true if the given object is an instance of EventApiDestination.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EventApiDestination;
    /**
