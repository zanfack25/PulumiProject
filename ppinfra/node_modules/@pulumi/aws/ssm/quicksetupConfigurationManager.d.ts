 ...
 * ```
 */
export declare class QuicksetupConfigurationManager extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: QuicksetupConfigurationManagerState, opts?: pulumi.CustomResourceOptions): QuicksetupConfigurationManager;
    /**
     ...
     */
    static isInstance(obj: any): obj is QuicksetupConfigurationManager;
    /**
     * Definition of the Quick Setup configuration that the configuration manager deploys. See `configurationDefinition` below.
     */
    readonly configurationDefinition: pulumi.Output<outputs.ssm.QuicksetupConfigurationManagerConfigurationDefinition | undefined>;
    /**
     ...
     */
    readonly managerArn: pulumi.Output<string>;
    /**
     ...
     */
    readonly statusSummaries: pulumi.Output<outputs.ssm.QuicksetupConfigurationManagerStatusSummary[]>;
    /**
    ...
    readonly timeouts: pulumi.Output<outputs.ssm.QuicksetupConfigurationManagerTimeouts | undefined>;
    /**
