 ...
 * ```
 */
export declare class HttpNamespace extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HttpNamespaceState, opts?: pulumi.CustomResourceOptions): HttpNamespace;
    /**
     * Returns true if the given object is an instance of HttpNamespace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HttpNamespace;
    /**
     ...
     */
    readonly httpName: pulumi.Output<string>;
    /**
