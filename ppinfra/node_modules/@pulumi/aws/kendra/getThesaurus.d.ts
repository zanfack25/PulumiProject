 ...
 * ```
 */
export declare function getThesaurus(args: GetThesaurusArgs, opts?: pulumi.InvokeOptions): Promise<GetThesaurusResult>;
/**
 ...
 * ```
 */
export declare function getThesaurusOutput(args: GetThesaurusOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetThesaurusResult>;
/**
 * A collection of arguments for invoking getThesaurus.
 */
