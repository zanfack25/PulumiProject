 ...
 * ```
 */
export declare function getExperience(args: GetExperienceArgs, opts?: pulumi.InvokeOptions): Promise<GetExperienceResult>;
/**
 ...
 * ```
 */
export declare function getExperienceOutput(args: GetExperienceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExperienceResult>;
/**
 * A collection of arguments for invoking getExperience.
 */
