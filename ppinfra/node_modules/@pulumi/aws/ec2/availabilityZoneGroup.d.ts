 ...
 * ```
 */
export declare class AvailabilityZoneGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AvailabilityZoneGroupState, opts?: pulumi.CustomResourceOptions): AvailabilityZoneGroup;
    /**
     * Returns true if the given object is an instance of AvailabilityZoneGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AvailabilityZoneGroup;
    /**
     ...
     */
    readonly optInStatus: pulumi.Output<string>;
    /**
