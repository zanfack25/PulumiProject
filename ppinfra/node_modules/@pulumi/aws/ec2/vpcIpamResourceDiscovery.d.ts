 ...
 * ```
 */
export declare class VpcIpamResourceDiscovery extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcIpamResourceDiscoveryState, opts?: pulumi.CustomResourceOptions): VpcIpamResourceDiscovery;
    /**
     * Returns true if the given object is an instance of VpcIpamResourceDiscovery.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is VpcIpamResourceDiscovery;
    /**
