...
class VpnConnection extends pulumi.CustomResource {
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["tunnel1PresharedKey"] = (args === null || args === void 0 ? void 0 : args.tunnel1PresharedKey) ? pulumi.secret(args.tunnel1PresharedKey) : undefined;
            ...
            resourceInputs["tunnel2PresharedKey"] = (args === null || args === void 0 ? void 0 : args.tunnel2PresharedKey) ? pulumi.secret(args.tunnel2PresharedKey) : undefined;
