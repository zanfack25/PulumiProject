 ...
 * ```
 */
export declare class NetworkAclAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkAclAssociationState, opts?: pulumi.CustomResourceOptions): NetworkAclAssociation;
    /**
     * Returns true if the given object is an instance of NetworkAclAssociation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NetworkAclAssociation;
    /**
