 ...
 * ```
 */
export declare class VpcNetworkPerformanceMetricSubscription extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcNetworkPerformanceMetricSubscriptionState, opts?: pulumi.CustomResourceOptions): VpcNetworkPerformanceMetricSubscription;
    /**
     ...
     */
    static isInstance(obj: any): obj is VpcNetworkPerformanceMetricSubscription;
    /**
