...
export declare class LocalGatewayRoute extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalGatewayRouteState, opts?: pulumi.CustomResourceOptions): LocalGatewayRoute;
    /**
     * Returns true if the given object is an instance of LocalGatewayRoute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LocalGatewayRoute;
    /**
