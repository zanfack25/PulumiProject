 ...
 * ```
 */
export declare function getVpcIpam(args: GetVpcIpamArgs, opts?: pulumi.InvokeOptions): Promise<GetVpcIpamResult>;
/**
 ...
 * ```
 */
export declare function getVpcIpamOutput(args: GetVpcIpamOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVpcIpamResult>;
/**
 * A collection of arguments for invoking getVpcIpam.
 */
