 ...
 * ```
 */
export declare class DefaultNetworkAcl extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultNetworkAclState, opts?: pulumi.CustomResourceOptions): DefaultNetworkAcl;
    /**
     * Returns true if the given object is an instance of DefaultNetworkAcl.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DefaultNetworkAcl;
    /**
     ...
     */
    readonly egress: pulumi.Output<outputs.ec2.DefaultNetworkAclEgress[] | undefined>;
    /**
     * Configuration block for an ingress rule. Detailed below.
     */
    readonly ingress: pulumi.Output<outputs.ec2.DefaultNetworkAclIngress[] | undefined>;
    /**
