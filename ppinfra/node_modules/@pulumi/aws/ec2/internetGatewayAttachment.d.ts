 ...
 * ```
 */
export declare class InternetGatewayAttachment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InternetGatewayAttachmentState, opts?: pulumi.CustomResourceOptions): InternetGatewayAttachment;
    /**
     ...
     */
    static isInstance(obj: any): obj is InternetGatewayAttachment;
    /**
