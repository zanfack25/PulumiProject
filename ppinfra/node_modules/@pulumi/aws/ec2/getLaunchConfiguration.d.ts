 ...
 * ```
 */
export declare function getLaunchConfiguration(args: GetLaunchConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetLaunchConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getLaunchConfigurationOutput(args: GetLaunchConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLaunchConfigurationResult>;
/**
 * A collection of arguments for invoking getLaunchConfiguration.
 */
