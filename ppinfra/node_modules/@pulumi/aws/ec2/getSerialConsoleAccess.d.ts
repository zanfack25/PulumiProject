 ...
 * ```
 */
export declare function getSerialConsoleAccess(opts?: pulumi.InvokeOptions): Promise<GetSerialConsoleAccessResult>;
/**
 ...
 * ```
 */
export declare function getSerialConsoleAccessOutput(opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSerialConsoleAccessResult>;
