 ...
 * ```
 */
export declare class VpcIpamOrganizationAdminAccount extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcIpamOrganizationAdminAccountState, opts?: pulumi.CustomResourceOptions): VpcIpamOrganizationAdminAccount;
    /**
     ...
     */
    static isInstance(obj: any): obj is VpcIpamOrganizationAdminAccount;
    /**
     * The Organizations ARN for the delegate account.
     */
    readonly arn: pulumi.Output<string>;
    readonly delegatedAdminAccountId: pulumi.Output<string>;
    /**
