 ...
 * ```
 */
export declare class NetworkInterfaceSecurityGroupAttachment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkInterfaceSecurityGroupAttachmentState, opts?: pulumi.CustomResourceOptions): NetworkInterfaceSecurityGroupAttachment;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkInterfaceSecurityGroupAttachment;
    /**
