 ...
 * ```
 */
export declare function getReservedInstanceOffering(args: GetReservedInstanceOfferingArgs, opts?: pulumi.InvokeOptions): Promise<GetReservedInstanceOfferingResult>;
/**
 ...
 * ```
 */
export declare function getReservedInstanceOfferingOutput(args: GetReservedInstanceOfferingOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReservedInstanceOfferingResult>;
/**
 * A collection of arguments for invoking getReservedInstanceOffering.
 */
