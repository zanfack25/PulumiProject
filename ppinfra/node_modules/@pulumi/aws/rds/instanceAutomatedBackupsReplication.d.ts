 ...
 * ```
 */
export declare class InstanceAutomatedBackupsReplication extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InstanceAutomatedBackupsReplicationState, opts?: pulumi.CustomResourceOptions): InstanceAutomatedBackupsReplication;
    /**
     ...
     */
    static isInstance(obj: any): obj is InstanceAutomatedBackupsReplication;
    /**
     ...
     */
    readonly sourceDbInstanceArn: pulumi.Output<string>;
    /**
