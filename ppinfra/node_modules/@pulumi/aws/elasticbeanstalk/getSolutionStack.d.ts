 ...
 * ```
 */
export declare function getSolutionStack(args: GetSolutionStackArgs, opts?: pulumi.InvokeOptions): Promise<GetSolutionStackResult>;
/**
 ...
 * ```
 */
export declare function getSolutionStackOutput(args: GetSolutionStackOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSolutionStackResult>;
/**
 * A collection of arguments for invoking getSolutionStack.
 */
