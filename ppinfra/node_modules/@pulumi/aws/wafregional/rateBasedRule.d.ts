 ...
 * ```
 */
export declare class RateBasedRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RateBasedRuleState, opts?: pulumi.CustomResourceOptions): RateBasedRule;
    /**
     * Returns true if the given object is an instance of RateBasedRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RateBasedRule;
    /**
     ...
     */
    readonly predicates: pulumi.Output<outputs.wafregional.RateBasedRulePredicate[] | undefined>;
    /**
     * Valid value is IP.
     */
    readonly rateKey: pulumi.Output<string>;
    /**
     * The maximum number of requests, which have an identical value in the field specified by the RateKey, allowed in a five-minute period. Minimum value is 100.
     */
    readonly rateLimit: pulumi.Output<number>;
    /**
