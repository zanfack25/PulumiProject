...
exports.getSubscribedRuleGroupOutput = exports.getSubscribedRuleGroup = void 0;
...
exports.getSubscribedRuleGroup = getSubscribedRuleGroup;
/**
 * `aws.wafregional.getSubscribedRuleGroup` retrieves information about a Managed WAF Rule Group from AWS Marketplace for use in WAF Regional (needs to be subscribed to first).
 *
 * ## Example Usage
 ...
 * ```
 */
function getSubscribedRuleGroupOutput(args, opts) {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getSubscribedRuleGroupOutput = getSubscribedRuleGroupOutput;
//# sourceMappingURL=getSubscribedRuleGroup.js.map