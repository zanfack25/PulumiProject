 ...
 * ```
 */
class MysqlLayer extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new MysqlLayer(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.MysqlLayer = MysqlLayer;
/** @internal */
MysqlLayer.__pulumiType = 'aws:opsworks/mysqlLayer:MysqlLayer';
//# sourceMappingURL=mysqlLayer.js.map