 ...
 * ```
 */
export declare class StaticWebLayer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StaticWebLayerState, opts?: pulumi.CustomResourceOptions): StaticWebLayer;
    /**
     * Returns true if the given object is an instance of StaticWebLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StaticWebLayer;
    /**
    ...
    readonly cloudwatchConfiguration: pulumi.Output<outputs.opsworks.StaticWebLayerCloudwatchConfiguration | undefined>;
     ...
     */
    readonly ebsVolumes: pulumi.Output<outputs.opsworks.StaticWebLayerEbsVolume[]>;
    /**
    ...
    readonly loadBasedAutoScaling: pulumi.Output<outputs.opsworks.StaticWebLayerLoadBasedAutoScaling>;
    /**
...
export interface StaticWebLayerState {
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.opsworks.StaticWebLayerLoadBasedAutoScaling>;
    /**
     * A human-readable name for the layer.
     */
