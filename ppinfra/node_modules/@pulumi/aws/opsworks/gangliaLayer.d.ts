 ...
 * ```
 */
export declare class GangliaLayer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GangliaLayerState, opts?: pulumi.CustomResourceOptions): GangliaLayer;
    /**
     * Returns true if the given object is an instance of GangliaLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GangliaLayer;
    /**
    ...
    readonly cloudwatchConfiguration: pulumi.Output<outputs.opsworks.GangliaLayerCloudwatchConfiguration | undefined>;
     ...
     */
    readonly ebsVolumes: pulumi.Output<outputs.opsworks.GangliaLayerEbsVolume[]>;
    /**
    ...
    readonly loadBasedAutoScaling: pulumi.Output<outputs.opsworks.GangliaLayerLoadBasedAutoScaling>;
    /**
