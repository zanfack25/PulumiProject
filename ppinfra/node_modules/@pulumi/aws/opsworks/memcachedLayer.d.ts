 ...
 * ```
 */
export declare class MemcachedLayer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MemcachedLayerState, opts?: pulumi.CustomResourceOptions): MemcachedLayer;
    /**
     * Returns true if the given object is an instance of MemcachedLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MemcachedLayer;
    /**
     * Amount of memory to allocate for the cache on each instance, in megabytes. Defaults to 512MB.
     */
    readonly allocatedMemory: pulumi.Output<number | undefined>;
    /**
    ...
    readonly cloudwatchConfiguration: pulumi.Output<outputs.opsworks.MemcachedLayerCloudwatchConfiguration | undefined>;
     ...
     */
    readonly ebsVolumes: pulumi.Output<outputs.opsworks.MemcachedLayerEbsVolume[]>;
    /**
    ...
    readonly loadBasedAutoScaling: pulumi.Output<outputs.opsworks.MemcachedLayerLoadBasedAutoScaling>;
    /**
...
export interface MemcachedLayerState {
    ...
    cloudwatchConfiguration?: pulumi.Input<inputs.opsworks.MemcachedLayerCloudwatchConfiguration>;
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.opsworks.MemcachedLayerLoadBasedAutoScaling>;
    /**
     * A human-readable name for the layer.
     */
