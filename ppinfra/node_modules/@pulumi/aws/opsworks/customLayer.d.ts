 ...
 * ```
 */
export declare class CustomLayer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomLayerState, opts?: pulumi.CustomResourceOptions): CustomLayer;
    /**
     * Returns true if the given object is an instance of CustomLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CustomLayer;
    /**
     ...
     */
    readonly cloudwatchConfiguration: pulumi.Output<outputs.opsworks.CustomLayerCloudwatchConfiguration | undefined>;
     ...
     */
    readonly ebsVolumes: pulumi.Output<outputs.opsworks.CustomLayerEbsVolume[]>;
    /**
     ...
     */
    readonly loadBasedAutoScaling: pulumi.Output<outputs.opsworks.CustomLayerLoadBasedAutoScaling>;
    /**
