 ...
 * ```
 */
export declare class PhpAppLayer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PhpAppLayerState, opts?: pulumi.CustomResourceOptions): PhpAppLayer;
    /**
     * Returns true if the given object is an instance of PhpAppLayer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is PhpAppLayer;
    /**
    ...
    readonly cloudwatchConfiguration: pulumi.Output<outputs.opsworks.PhpAppLayerCloudwatchConfiguration | undefined>;
     ...
     */
    readonly ebsVolumes: pulumi.Output<outputs.opsworks.PhpAppLayerEbsVolume[]>;
    /**
    ...
    readonly loadBasedAutoScaling: pulumi.Output<outputs.opsworks.PhpAppLayerLoadBasedAutoScaling>;
    /**
