 ...
 * ```
 */
export declare function getTableItem(args: GetTableItemArgs, opts?: pulumi.InvokeOptions): Promise<GetTableItemResult>;
/**
 ...
 * ```
 */
export declare function getTableItemOutput(args: GetTableItemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTableItemResult>;
/**
 * A collection of arguments for invoking getTableItem.
 */
export interface GetTableItemOutputArgs {
    expressionAttributeNames?: pulumi.Input<{
