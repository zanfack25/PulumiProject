 ...
 * ```
 */
export declare function getReplicationTaskOutput(args: GetReplicationTaskOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicationTaskResult>;
/**
 * A collection of arguments for invoking getReplicationTask.
 */
