 ...
 * ```
 */
export declare function getReplicationInstance(args: GetReplicationInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationInstanceResult>;
/**
 ...
 * ```
 */
export declare function getReplicationInstanceOutput(args: GetReplicationInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicationInstanceResult>;
/**
 * A collection of arguments for invoking getReplicationInstance.
 */
