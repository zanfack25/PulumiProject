...
export declare class S3Endpoint extends pulumi.CustomResource {
     ...
     */
    readonly addColumnName: pulumi.Output<boolean | undefined>;
    /**
     * Whether to add padding. Default is `false`. (Ignored for source endpoints.)
     */
    readonly addTrailingPaddingCharacter: pulumi.Output<boolean | undefined>;
    /**
     * S3 object prefix.
     */
    readonly bucketFolder: pulumi.Output<string | undefined>;
    /**
     * S3 bucket name.
     */
     ...
     */
    readonly cdcPath: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly csvDelimiter: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly csvNoSupValue: pulumi.Output<string | undefined>;
    /**
     * String to as null when writing to the target. (AWS default is `NULL`.)
     */
    readonly csvNullValue: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly dataPageSize: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly datePartitionDelimiter: pulumi.Output<string | undefined>;
    /**
     * Partition S3 bucket folders based on transaction commit dates. Default is `false`. (Ignored for source endpoints.)
     */
    readonly datePartitionEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly datePartitionSequence: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly datePartitionTimezone: pulumi.Output<string | undefined>;
    /**
     * Undocumented argument for use as directed by AWS Support.
     */
    readonly detachTargetOnLobLookupFailureParquet: pulumi.Output<boolean | undefined>;
    /**
     * Maximum size in bytes of an encoded dictionary page of a column. (AWS default is 1 MiB, _i.e._, `1048576`.)
     */
    readonly dictPageSizeLimit: pulumi.Output<number | undefined>;
    /**
     * Whether to enable statistics for Parquet pages and row groups. Default is `true`.
     */
    readonly enableStatistics: pulumi.Output<boolean | undefined>;
    /**
     * Type of encoding to use. Value values are `rleDictionary`, `plain`, and `plainDictionary`. (AWS default is `rleDictionary`.)
     */
    readonly encodingType: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly encryptionMode: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly engineDisplayName: pulumi.Output<string>;
    /**
     ...
     */
    readonly externalTableDefinition: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly glueCatalogGeneration: pulumi.Output<boolean | undefined>;
    /**
     * When this value is set to `1`, DMS ignores the first row header in a .csv file. (AWS default is `0`.)
     */
    readonly ignoreHeaderRows: pulumi.Output<number | undefined>;
    /**
     * Whether to enable a full load to write INSERT operations to the .csv output files only to indicate how the rows were added to the source database. Default is `false`.
     */
    readonly includeOpForFullLoad: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly maxFileSize: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly parquetTimestampInMillisecond: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly parquetVersion: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly preserveTransactions: pulumi.Output<boolean | undefined>;
    /**
     * For an S3 source, whether each leading double quotation mark has to be followed by an ending double quotation mark. Default is `true`.
     */
    readonly rfc4180: pulumi.Output<boolean | undefined>;
    /**
     * Number of rows in a row group. (AWS default is `10000`.)
     */
    readonly rowGroupLength: pulumi.Output<number | undefined>;
    /**
     * When `encryptionMode` is `SSE_KMS`, ARN for the AWS KMS key. (Ignored for source endpoints -- only `SSE_S3` `encryptionMode` is valid.)
     */
    readonly serverSideEncryptionKmsKeyId: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly timestampColumnName: pulumi.Output<string | undefined>;
    /**
     * Whether to use `csvNoSupValue` for columns not included in the supplemental log. (Ignored for source endpoints.)
     */
    readonly useCsvNoSupValue: pulumi.Output<boolean | undefined>;
    /**
     * When set to `true`, uses the task start time as the timestamp column value instead of the time data is written to target. For full load, when set to `true`, each row of the timestamp column contains the task start time. For CDC loads, each row of the timestamp column contains the transaction commit time.When set to false, the full load timestamp in the timestamp column increments with the time data arrives at the target. Default is `false`.
     */
    readonly useTaskStartTimeForFullLoadTimestamp: pulumi.Output<boolean | undefined>;
    /**
