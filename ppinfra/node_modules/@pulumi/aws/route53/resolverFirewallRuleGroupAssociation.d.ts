 ...
 * ```
 */
export declare class ResolverFirewallRuleGroupAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResolverFirewallRuleGroupAssociationState, opts?: pulumi.CustomResourceOptions): ResolverFirewallRuleGroupAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is ResolverFirewallRuleGroupAssociation;
    /**
     ...
     */
    readonly mutationProtection: pulumi.Output<string>;
    /**
