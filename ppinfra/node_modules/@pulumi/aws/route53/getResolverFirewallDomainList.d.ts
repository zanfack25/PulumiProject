 ...
 * ```
 */
export declare function getResolverFirewallDomainList(args: GetResolverFirewallDomainListArgs, opts?: pulumi.InvokeOptions): Promise<GetResolverFirewallDomainListResult>;
/**
 ...
 * ```
 */
export declare function getResolverFirewallDomainListOutput(args: GetResolverFirewallDomainListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResolverFirewallDomainListResult>;
/**
 * A collection of arguments for invoking getResolverFirewallDomainList.
 */
