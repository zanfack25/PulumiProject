 ...
 * ```
 */
export declare class ProfilesAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProfilesAssociationState, opts?: pulumi.CustomResourceOptions): ProfilesAssociation;
    /**
     * Returns true if the given object is an instance of ProfilesAssociation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProfilesAssociation;
    ...
    readonly timeouts: pulumi.Output<outputs.route53.ProfilesAssociationTimeouts | undefined>;
    /**
