...
exports.getDelegationSetOutput = exports.getDelegationSet = void 0;
 ...
 * ```
 */
function getDelegationSetOutput(args, opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("aws:route53/getDelegationSet:getDelegationSet", {
        "id": args.id,
    }, opts);
}
exports.getDelegationSetOutput = getDelegationSetOutput;
