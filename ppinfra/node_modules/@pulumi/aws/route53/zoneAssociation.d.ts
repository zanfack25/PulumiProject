 ...
 * ```
 */
export declare class ZoneAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZoneAssociationState, opts?: pulumi.CustomResourceOptions): ZoneAssociation;
    /**
     * Returns true if the given object is an instance of ZoneAssociation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ZoneAssociation;
    /**
     * The account ID of the account that created the hosted zone.
     */
    readonly owningAccount: pulumi.Output<string>;
    /**
