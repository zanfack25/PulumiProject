 ...
 * ```
 */
export declare class HostedZoneDnsSec extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HostedZoneDnsSecState, opts?: pulumi.CustomResourceOptions): HostedZoneDnsSec;
    /**
     * Returns true if the given object is an instance of HostedZoneDnsSec.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is HostedZoneDnsSec;
    /**
     ...
     */
    readonly signingStatus: pulumi.Output<string | undefined>;
    /**
