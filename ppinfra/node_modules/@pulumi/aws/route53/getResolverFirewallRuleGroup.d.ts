 ...
 * ```
 */
export declare function getResolverFirewallRuleGroup(args: GetResolverFirewallRuleGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetResolverFirewallRuleGroupResult>;
/**
 ...
 * ```
 */
export declare function getResolverFirewallRuleGroupOutput(args: GetResolverFirewallRuleGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResolverFirewallRuleGroupResult>;
/**
 * A collection of arguments for invoking getResolverFirewallRuleGroup.
 */
