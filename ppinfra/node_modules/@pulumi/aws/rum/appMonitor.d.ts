...
export declare class AppMonitor extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppMonitorState, opts?: pulumi.CustomResourceOptions): AppMonitor;
    /**
     ...
     */
    readonly customEvents: pulumi.Output<outputs.rum.AppMonitorCustomEvents>;
    /**
