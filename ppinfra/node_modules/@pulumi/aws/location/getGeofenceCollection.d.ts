 ...
 * ```
 */
export declare function getGeofenceCollection(args: GetGeofenceCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetGeofenceCollectionResult>;
/**
 ...
 * ```
 */
export declare function getGeofenceCollectionOutput(args: GetGeofenceCollectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGeofenceCollectionResult>;
/**
 * A collection of arguments for invoking getGeofenceCollection.
 */
