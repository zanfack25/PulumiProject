 ...
 * ```
 */
export declare class RouteCalculation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RouteCalculationState, opts?: pulumi.CustomResourceOptions): RouteCalculation;
    /**
     * Returns true if the given object is an instance of RouteCalculation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RouteCalculation;
    /**
     * The Amazon Resource Name (ARN) for the Route calculator resource. Use the ARN when you specify a resource across AWS.
     */
    readonly calculatorArn: pulumi.Output<string>;
    /**
     * The name of the route calculator resource.
     */
    readonly calculatorName: pulumi.Output<string>;
    /**
