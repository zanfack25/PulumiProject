...
function getLocations(opts) {
    ...
    return pulumi.runtime.invoke("aws:directconnect/getLocations:getLocations", {}, opts);
}
...
function getLocationsOutput(opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("aws:directconnect/getLocations:getLocations", {}, opts);
}
