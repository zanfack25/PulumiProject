 ...
 * ```
 */
export declare function getRouterConfiguration(args: GetRouterConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetRouterConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getRouterConfigurationOutput(args: GetRouterConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRouterConfigurationResult>;
/**
 * A collection of arguments for invoking getRouterConfiguration.
 */
