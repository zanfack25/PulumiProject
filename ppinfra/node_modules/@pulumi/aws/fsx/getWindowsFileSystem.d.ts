 ...
 * ```
 */
export declare function getWindowsFileSystem(args: GetWindowsFileSystemArgs, opts?: pulumi.InvokeOptions): Promise<GetWindowsFileSystemResult>;
/**
 ...
 * ```
 */
export declare function getWindowsFileSystemOutput(args: GetWindowsFileSystemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWindowsFileSystemResult>;
/**
 * A collection of arguments for invoking getWindowsFileSystem.
 */
