 ...
 * ```
 */
export declare function getOntapFileSystem(args: GetOntapFileSystemArgs, opts?: pulumi.InvokeOptions): Promise<GetOntapFileSystemResult>;
/**
 ...
 * ```
 */
export declare function getOntapFileSystemOutput(args: GetOntapFileSystemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOntapFileSystemResult>;
/**
 * A collection of arguments for invoking getOntapFileSystem.
 */
