 ...
 * ```
 */
export declare function getContactChannelOutput(args: GetContactChannelOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetContactChannelResult>;
/**
 * A collection of arguments for invoking getContactChannel.
 */
