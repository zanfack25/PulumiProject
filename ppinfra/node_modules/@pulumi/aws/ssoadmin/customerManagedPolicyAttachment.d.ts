 ...
 * ```
 */
export declare class CustomerManagedPolicyAttachment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CustomerManagedPolicyAttachmentState, opts?: pulumi.CustomResourceOptions): CustomerManagedPolicyAttachment;
    /**
     ...
     */
    static isInstance(obj: any): obj is CustomerManagedPolicyAttachment;
    /**
     * Specifies the name and path of a customer managed policy. See below.
     */
    readonly customerManagedPolicyReference: pulumi.Output<outputs.ssoadmin.CustomerManagedPolicyAttachmentCustomerManagedPolicyReference>;
    /**
