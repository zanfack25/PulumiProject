 ...
 * ```
 */
export declare class Smsvoicev2OptOutList extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Smsvoicev2OptOutListState, opts?: pulumi.CustomResourceOptions): Smsvoicev2OptOutList;
    /**
     * Returns true if the given object is an instance of Smsvoicev2OptOutList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Smsvoicev2OptOutList;
    /**
