 ...
 * ```
 */
export declare class ApnsVoipSandboxChannel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApnsVoipSandboxChannelState, opts?: pulumi.CustomResourceOptions): ApnsVoipSandboxChannel;
    /**
     * Returns true if the given object is an instance of ApnsVoipSandboxChannel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ApnsVoipSandboxChannel;
    /**
     * The application ID.
     */
