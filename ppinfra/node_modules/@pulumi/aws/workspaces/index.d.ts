...
export declare const ConnectionAlias: typeof import("./connectionAlias").ConnectionAlias;
...
export declare const getBundle: typeof import("./getBundle").getBundle;
export declare const getBundleOutput: typeof import("./getBundle").getBundleOutput;
