 ...
 * ```
 */
export declare function getTaskExecution(args: GetTaskExecutionArgs, opts?: pulumi.InvokeOptions): Promise<GetTaskExecutionResult>;
/**
 ...
 * ```
 */
export declare function getTaskExecutionOutput(args: GetTaskExecutionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTaskExecutionResult>;
/**
 * A collection of arguments for invoking getTaskExecution.
 */
