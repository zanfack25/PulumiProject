...
export declare class ScheduledQuery extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScheduledQueryState, opts?: pulumi.CustomResourceOptions): ScheduledQuery;
    /**
     ...
     */
    readonly errorReportConfiguration: pulumi.Output<outputs.timestreamquery.ScheduledQueryErrorReportConfiguration>;
    /**
     ...
     */
    readonly lastRunSummaries: pulumi.Output<outputs.timestreamquery.ScheduledQueryLastRunSummary[] | undefined>;
    /**
     ...
     */
    readonly nextInvocationTime: pulumi.Output<string>;
    /**
     ...
     */
    readonly notificationConfiguration: pulumi.Output<outputs.timestreamquery.ScheduledQueryNotificationConfiguration>;
    /**
     * Last time the scheduled query was run.
     */
    readonly previousInvocationTime: pulumi.Output<string>;
    /**
     ...
     */
    readonly recentlyFailedRuns: pulumi.Output<outputs.timestreamquery.ScheduledQueryRecentlyFailedRun[] | undefined>;
    /**
     * Configuration block for schedule configuration for the query. See below.
     */
    readonly scheduleConfiguration: pulumi.Output<outputs.timestreamquery.ScheduledQueryScheduleConfiguration>;
    /**
     ...
     */
    readonly targetConfiguration: pulumi.Output<outputs.timestreamquery.ScheduledQueryTargetConfiguration>;
    readonly timeouts: pulumi.Output<outputs.timestreamquery.ScheduledQueryTimeouts | undefined>;
    /**
