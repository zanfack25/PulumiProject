...
export declare const AnalyticsApplication: typeof import("./analyticsApplication").AnalyticsApplication;
...
export declare const FirehoseDeliveryStream: typeof import("./firehoseDeliveryStream").FirehoseDeliveryStream;
...
export declare const getFirehoseDeliveryStream: typeof import("./getFirehoseDeliveryStream").getFirehoseDeliveryStream;
export declare const getFirehoseDeliveryStreamOutput: typeof import("./getFirehoseDeliveryStream").getFirehoseDeliveryStreamOutput;
...
export declare const getStreamConsumer: typeof import("./getStreamConsumer").getStreamConsumer;
export declare const getStreamConsumerOutput: typeof import("./getStreamConsumer").getStreamConsumerOutput;
...
export declare const StreamConsumer: typeof import("./streamConsumer").StreamConsumer;
export { VideoStreamArgs, VideoStreamState } from "./videoStream";
export type VideoStream = import("./videoStream").VideoStream;
export declare const VideoStream: typeof import("./videoStream").VideoStream;
