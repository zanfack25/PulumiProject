...
export declare class ServiceNetworkVpcAssociation extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceNetworkVpcAssociationState, opts?: pulumi.CustomResourceOptions): ServiceNetworkVpcAssociation;
    /**
     ...
     * The ID of the VPC.
     */
    readonly vpcIdentifier: pulumi.Output<string>;
    /**
