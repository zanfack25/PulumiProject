 ...
 * ```
 */
export declare function getMultiRegionAccessPoint(args: GetMultiRegionAccessPointArgs, opts?: pulumi.InvokeOptions): Promise<GetMultiRegionAccessPointResult>;
/**
 ...
 * ```
 */
export declare function getMultiRegionAccessPointOutput(args: GetMultiRegionAccessPointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMultiRegionAccessPointResult>;
/**
 * A collection of arguments for invoking getMultiRegionAccessPoint.
 */
