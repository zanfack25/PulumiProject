 ...
 * ```
 */
export declare class AccessGrantsInstanceResourcePolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessGrantsInstanceResourcePolicyState, opts?: pulumi.CustomResourceOptions): AccessGrantsInstanceResourcePolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is AccessGrantsInstanceResourcePolicy;
