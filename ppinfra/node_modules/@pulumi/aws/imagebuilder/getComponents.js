...
exports.getComponentsOutput = exports.getComponents = void 0;
 ...
 * ```
 */
function getComponents(args, opts) {
    args = args || {};
 ...
 * ```
 */
function getComponentsOutput(args, opts) {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
exports.getComponentsOutput = getComponentsOutput;
