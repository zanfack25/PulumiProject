 ...
 * ```
 */
export declare function getInfrastructureConfiguration(args: GetInfrastructureConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetInfrastructureConfigurationResult>;
/**
 ...
 * ```
 */
export declare function getInfrastructureConfigurationOutput(args: GetInfrastructureConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInfrastructureConfigurationResult>;
/**
 * A collection of arguments for invoking getInfrastructureConfiguration.
 */
