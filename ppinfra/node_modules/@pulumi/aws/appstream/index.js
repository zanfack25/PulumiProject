...
exports.UserStackAssociation = exports.User = exports.Stack = exports.ImageBuilder = exports.getImageOutput = exports.getImage = exports.FleetStackAssociation = exports.Fleet = exports.DirectoryConfig = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.DirectoryConfig = null;
utilities.lazyLoad(exports, ["DirectoryConfig"], () => require("./directoryConfig"));
exports.Fleet = null;
utilities.lazyLoad(exports, ["Fleet"], () => require("./fleet"));
exports.FleetStackAssociation = null;
...
exports.UserStackAssociation = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws:appstream/directoryConfig:DirectoryConfig":
                return new exports.DirectoryConfig(name, undefined, { urn });
            ...
            case "aws:appstream/fleetStackAssociation:FleetStackAssociation":
                return new exports.FleetStackAssociation(name, undefined, { urn });
            ...
            case "aws:appstream/userStackAssociation:UserStackAssociation":
                return new exports.UserStackAssociation(name, undefined, { urn });
            default:
