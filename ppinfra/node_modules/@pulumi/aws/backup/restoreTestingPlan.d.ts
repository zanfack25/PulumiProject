 ...
 * ```
 */
export declare class RestoreTestingPlan extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RestoreTestingPlanState, opts?: pulumi.CustomResourceOptions): RestoreTestingPlan;
    /**
     * Returns true if the given object is an instance of RestoreTestingPlan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RestoreTestingPlan;
    /**
     ...
     */
    readonly recoveryPointSelection: pulumi.Output<outputs.backup.RestoreTestingPlanRecoveryPointSelection | undefined>;
    /**
     ...
     */
    readonly scheduleExpressionTimezone: pulumi.Output<string>;
    /**
     * The number of hours in the start window for the restore testing plan. Must be between 1 and 168.
     */
    readonly startWindowHours: pulumi.Output<number>;
