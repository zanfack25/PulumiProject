 ...
 * ```
 */
export declare function getSelection(args: GetSelectionArgs, opts?: pulumi.InvokeOptions): Promise<GetSelectionResult>;
/**
 ...
 * ```
 */
export declare function getSelectionOutput(args: GetSelectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSelectionResult>;
/**
 * A collection of arguments for invoking getSelection.
 */
