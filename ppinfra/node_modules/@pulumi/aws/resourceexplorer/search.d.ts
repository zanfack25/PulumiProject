 ...
 * ```
 */
export declare function search(args: SearchArgs, opts?: pulumi.InvokeOptions): Promise<SearchResult>;
/**
 ...
 * ```
 */
export declare function searchOutput(args: SearchOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<SearchResult>;
/**
 * A collection of arguments for invoking Search.
 */
