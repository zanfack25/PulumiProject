 ...
 * ```
 */
export declare class LocationFsxWindows extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocationFsxWindowsState, opts?: pulumi.CustomResourceOptions): LocationFsxWindows;
    /**
     * Returns true if the given object is an instance of LocationFsxWindows.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LocationFsxWindows;
    /**
