...
exports.RetentionConfiguration = void 0;
...
class RetentionConfiguration extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new RetentionConfiguration(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
RetentionConfiguration.__pulumiType = 'aws:cfg/retentionConfiguration:RetentionConfiguration';
