...
export declare class OrganizationConformancePack extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OrganizationConformancePackState, opts?: pulumi.CustomResourceOptions): OrganizationConformancePack;
    /**
     ...
     */
    readonly inputParameters: pulumi.Output<outputs.cfg.OrganizationConformancePackInputParameter[] | undefined>;
    /**
