 ...
 * ```
 */
export declare class BucketOwnershipControls extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BucketOwnershipControlsState, opts?: pulumi.CustomResourceOptions): BucketOwnershipControls;
    /**
     * Returns true if the given object is an instance of BucketOwnershipControls.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BucketOwnershipControls;
    /**
     ...
     */
    readonly rule: pulumi.Output<outputs.s3.BucketOwnershipControlsRule>;
    /**
