 ...
 */
export declare function getObjects(args: GetObjectsArgs, opts?: pulumi.InvokeOptions): Promise<GetObjectsResult>;
/**
 ...
 * The objects data source returns keys (i.e., file names) and other metadata about objects in an S3 bucket.
 */
export declare function getObjectsOutput(args: GetObjectsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetObjectsResult>;
/**
 * A collection of arguments for invoking getObjects.
 */
