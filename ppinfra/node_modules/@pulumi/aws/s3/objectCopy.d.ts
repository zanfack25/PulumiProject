 ...
 * ```
 */
export declare class ObjectCopy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ObjectCopyState, opts?: pulumi.CustomResourceOptions): ObjectCopy;
    /**
     * Returns true if the given object is an instance of ObjectCopy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ObjectCopy;
    /**
     ...
     */
    readonly contentLanguage: pulumi.Output<string>;
    /**
     ...
     */
    readonly copyIfMatch: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly copyIfModifiedSince: pulumi.Output<string | undefined>;
    /**
     * Copies the object if its entity tag (ETag) is different than the specified ETag.
     */
    readonly copyIfNoneMatch: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly copyIfUnmodifiedSince: pulumi.Output<string | undefined>;
    /**
     * Specifies the algorithm to use to when encrypting the object (for example, AES256).
     */
    readonly customerAlgorithm: pulumi.Output<string>;
    /**
     * Specifies the customer-provided encryption key for Amazon S3 to use in encrypting data. This value is used to store the object and then it is discarded; Amazon S3 does not store the encryption key. The key must be appropriate for use with the algorithm specified in the x-amz-server-side-encryption-customer-algorithm header.
     */
    readonly customerKey: pulumi.Output<string | undefined>;
    /**
     * Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses this header for a message integrity check to ensure that the encryption key was transmitted without error.
     */
    readonly customerKeyMd5: pulumi.Output<string>;
    /**
     ...
     */
    readonly expectedSourceBucketOwner: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly grants: pulumi.Output<outputs.s3.ObjectCopyGrant[] | undefined>;
    /**
     ...
     */
    readonly kmsEncryptionContext: pulumi.Output<string>;
    /**
     ...
     */
    readonly metadataDirective: pulumi.Output<string | undefined>;
    /**
     * The [legal hold](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock-overview.html#object-lock-legal-holds) status that you want to apply to the specified object. Valid values are `ON` and `OFF`.
     */
    readonly objectLockLegalHoldStatus: pulumi.Output<string>;
    /**
     * Object lock [retention mode](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock-overview.html#object-lock-retention-modes) that you want to apply to this object. Valid values are `GOVERNANCE` and `COMPLIANCE`.
     */
    readonly objectLockMode: pulumi.Output<string>;
    /**
     * Date and time, in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8), when this object's object lock will [expire](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock-overview.html#object-lock-retention-periods).
     */
    readonly objectLockRetainUntilDate: pulumi.Output<string>;
    readonly overrideProvider: pulumi.Output<outputs.s3.ObjectCopyOverrideProvider | undefined>;
    /**
     * If present, indicates that the requester was successfully charged for the request.
     */
    readonly requestCharged: pulumi.Output<boolean>;
    /**
     * Confirms that the requester knows that they will be charged for the request. Bucket owners need not specify this parameter in their requests. For information about downloading objects from requester pays buckets, see Downloading Objects in Requestor Pays Buckets (https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html) in the Amazon S3 Developer Guide. If included, the only valid value is `requester`.
     */
    readonly requestPayer: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly sourceCustomerAlgorithm: pulumi.Output<string | undefined>;
    /**
     * Specifies the customer-provided encryption key for Amazon S3 to use to decrypt the source object. The encryption key provided in this header must be one that was used when the source object was created.
     */
    readonly sourceCustomerKey: pulumi.Output<string | undefined>;
    /**
     * Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses this header for a message integrity check to ensure that the encryption key was transmitted without error.
     */
    readonly sourceCustomerKeyMd5: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly taggingDirective: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly websiteRedirect: pulumi.Output<string>;
    /**
