 ...
 * ```
 */
export declare function getServiceQuota(args: GetServiceQuotaArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceQuotaResult>;
/**
 ...
 * ```
 */
export declare function getServiceQuotaOutput(args: GetServiceQuotaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceQuotaResult>;
/**
 * A collection of arguments for invoking getServiceQuota.
 */
