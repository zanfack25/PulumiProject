 ...
 * ```
 */
export declare function getCustomModel(args: GetCustomModelArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomModelResult>;
/**
 ...
 * ```
 */
export declare function getCustomModelOutput(args: GetCustomModelOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomModelResult>;
/**
 * A collection of arguments for invoking getCustomModel.
 */
