...
function getRepositories(opts) {
    ...
    return pulumi.runtime.invoke("aws:ecr/getRepositories:getRepositories", {}, opts);
}
...
function getRepositoriesOutput(opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("aws:ecr/getRepositories:getRepositories", {}, opts);
}
