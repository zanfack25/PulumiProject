 ...
 * ```
 */
export declare function getRulesPackages(opts?: pulumi.InvokeOptions): Promise<GetRulesPackagesResult>;
/**
 ...
 * ```
 */
export declare function getRulesPackagesOutput(opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRulesPackagesResult>;
