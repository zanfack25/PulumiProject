 ...
 * ```
 */
export declare function getSdk(args: GetSdkArgs, opts?: pulumi.InvokeOptions): Promise<GetSdkResult>;
/**
 ...
 * ```
 */
export declare function getSdkOutput(args: GetSdkOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSdkResult>;
/**
 * A collection of arguments for invoking getSdk.
 */
