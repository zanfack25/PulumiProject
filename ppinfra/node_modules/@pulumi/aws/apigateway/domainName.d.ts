...
export declare class DomainName extends pulumi.CustomResource {
     ...
     */
    readonly certificatePrivateKey: pulumi.Output<string | undefined>;
    /**
     * Upload date associated with the domain certificate.
     */
    readonly certificateUploadDate: pulumi.Output<string>;
    /**
     * Hostname created by Cloudfront to represent the distribution that implements this domain name mapping.
     */
    readonly cloudfrontDomainName: pulumi.Output<string>;
    /**
     * For convenience, the hosted zone ID (`Z2FDTNDATAQYW2`) that can be used to create a Route53 alias record for the distribution.
     */
    readonly cloudfrontZoneId: pulumi.Output<string>;
    /**
     ...
     */
    readonly endpointConfiguration: pulumi.Output<outputs.apigateway.DomainNameEndpointConfiguration>;
    /**
     ...
     */
    readonly regionalCertificateName: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly regionalZoneId: pulumi.Output<string>;
    /**
