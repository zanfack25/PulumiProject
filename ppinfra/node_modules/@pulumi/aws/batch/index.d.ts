...
export declare const ComputeEnvironment: typeof import("./computeEnvironment").ComputeEnvironment;
export { GetComputeEnvironmentArgs, GetComputeEnvironmentResult, GetComputeEnvironmentOutputArgs } from "./getComputeEnvironment";
export declare const getComputeEnvironment: typeof import("./getComputeEnvironment").getComputeEnvironment;
export declare const getComputeEnvironmentOutput: typeof import("./getComputeEnvironment").getComputeEnvironmentOutput;
...
export declare const getJobQueue: typeof import("./getJobQueue").getJobQueue;
export declare const getJobQueueOutput: typeof import("./getJobQueue").getJobQueueOutput;
export { GetSchedulingPolicyArgs, GetSchedulingPolicyResult, GetSchedulingPolicyOutputArgs } from "./getSchedulingPolicy";
export declare const getSchedulingPolicy: typeof import("./getSchedulingPolicy").getSchedulingPolicy;
export declare const getSchedulingPolicyOutput: typeof import("./getSchedulingPolicy").getSchedulingPolicyOutput;
...
export declare const JobQueue: typeof import("./jobQueue").JobQueue;
...
export declare const SchedulingPolicy: typeof import("./schedulingPolicy").SchedulingPolicy;
