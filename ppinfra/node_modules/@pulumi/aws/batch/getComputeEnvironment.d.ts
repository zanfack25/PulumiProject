 ...
 * ```
 */
export declare function getComputeEnvironment(args: GetComputeEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetComputeEnvironmentResult>;
/**
 ...
 * ```
 */
export declare function getComputeEnvironmentOutput(args: GetComputeEnvironmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetComputeEnvironmentResult>;
/**
 * A collection of arguments for invoking getComputeEnvironment.
 */
