 ...
 * ```
 */
export declare class Cell extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CellState, opts?: pulumi.CustomResourceOptions): Cell;
    /**
     * Returns true if the given object is an instance of Cell.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Cell;
    /**
     * ARN of the cell
     */
     ...
     */
    readonly cellName: pulumi.Output<string>;
    /**
