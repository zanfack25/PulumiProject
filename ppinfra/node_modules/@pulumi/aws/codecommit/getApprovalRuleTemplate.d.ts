 ...
 * ```
 */
export declare function getApprovalRuleTemplateOutput(args: GetApprovalRuleTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApprovalRuleTemplateResult>;
/**
 * A collection of arguments for invoking getApprovalRuleTemplate.
 */
